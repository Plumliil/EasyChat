...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c("submit", {
        attrs: { _i: 28 },
        on: { subMsg: _vm.subMsg, hightChange: _vm.hightChange }
      })
    ],
    1
  )
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0;\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nvar _datas = _interopRequireDefault(__webpack_require__(/*! ../../commons/js/datas.js */ 10));\nvar _time = _interopRequireDefault(__webpack_require__(/*! ../../commons/js/utils/time.js */ 11));\nvar _topBar = _interopRequireDefault(__webpack_require__(/*! ../../components/bar/top-bar.vue */ 12));\nvar _submit = _interopRequireDefault(__webpack_require__(/*! ../../components/chat/submit.vue */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default = { components: { topBar: _topBar.default, submit: _submit.default }, data: function data() {return { msgArr: [], imgMsg: [], oldTime: new Date(), // pdInput:10\n      isMore: false, contentHeight: 0 };}, onLoad: function onLoad() {this.getChatDate();this.toBottom();}, onPageScroll: function onPageScroll() {this.contentHeight = uni.getSystemInfoSync().windowHeight;}, methods: { back: function back() {uni.navigateBack({ delta: 1 });}, // 获取聊天数据\n    getChatDate: function getChatDate() {var _this = this;this.msgArr = _datas.default.chatMsg();this.msgArr.forEach(function (item) {// 时间转换\n        var t = _time.default.spaceTime(_this.oldTime, item.time);_this.oldTime = t === '' ? _this.oldTime : t;item.time = t === '' ? t : _time.default.dateTime(t);item.imgUrl = '../../static/images/index/' + item.imgUrl; // 类型显示\n        if (item.types === 1) {item.message = '../../static/' + item.message;_this.imgMsg.push(item.message);}});this.msgArr = this.msgArr.reverse();this.imgMsg = this.imgMsg.reverse();}, // 预览图片\n    previewImg: function previewImg(url) {var curIndex = 0;this.imgMsg.forEach(function (item, index) {if (item == url) {curIndex = index;}__f__(\"log\", item, \" at pages/chatRoom/chatRoom.vue:111\");});uni.previewImage({ current: curIndex,\n        urls: this.imgMsg,\n        longPressActions: {\n          itemList: ['发送给朋友', '保存图片', '收藏'],\n          success: function success(data) {\n            __f__(\"log\", '选中了第' + (data.tapIndex + 1) + '个按钮,第' + (data.index + 1) + '张图片', \" at pages/chatRoom/chatRoom.vue:119\");\n          },\n          fail: function fail(err) {\n            __f__(\"log\", err.errMsg, \" at pages/chatRoom/chatRoom.vue:122\");\n          } } });\n\n\n    },\n    // 文字\n    subMsg: function subMsg(data) {\n      __f__(\"log\", data, \" at pages/chatRoom/chatRoom.vue:129\");\n      var msg = {\n        id: 'b',\n        imgUrl: '../../static/images/index/p1.jpeg',\n        message: data,\n        types: 0,\n        time: new Date(),\n        tip: 8 };\n\n      this.msgArr.push(msg);\n      __f__(\"log\", this.msgArr, \" at pages/chatRoom/chatRoom.vue:139\");\n      this.toBottom();\n    },\n    // 返回底部\n    toBottom: function toBottom() {\n      this.contentHeight = uni.getSystemInfoSync().windowHeight;\n      this.$nextTick(function () {\n        uni.pageScrollTo({\n          scrollTop: this.contentHeight,\n          duration: 300 });\n\n      });\n    },\n\n    hightChange: function hightChange(data) {\n      this.isMore = data;\n      this.toBottom();\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///8\n");
            ...
            _c("image", {
              attrs: {
                src: _vm._$s(
                  3,
                  "a-src",
                  __webpack_require__(/*! ../../static/images/chat/voice.png */ 21)
                ),
                _i: 3
              }
            })
        ...
        _c(
          ...
          _vm._l(_vm._$s(11, "f", { forItems: _vm.emojis }), function(
            ...
            return _c(
              ...
              _vm._l(_vm._$s(12 + "-" + $30, "f", { forItems: line }), function(
                item,
                index,
                $21,
                $31
                ...
                return _c(
                  ...
                  [
                    _vm._v(
                      _vm._$s("12-" + $30 + "-" + $31, "t0-0", _vm._s(item))
                    )
                  ]
                )
              }),
...
/* 21 */
/*!***************************************************************************!*\
  !*** C:/Users/22584/Desktop/EasyChat/client/static/images/chat/voice.png ***!
  \***************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

eval("module.exports = \"/static/images/chat/voice.png\";//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbbnVsbF0sIm5hbWVzIjpbXSwibWFwcGluZ3MiOiJBQUFBIiwiZmlsZSI6IjIxLmpzIiwic291cmNlc0NvbnRlbnQiOlsibW9kdWxlLmV4cG9ydHMgPSBcIi9zdGF0aWMvaW1hZ2VzL2NoYXQvdm9pY2UucG5nXCI7Il0sInNvdXJjZVJvb3QiOiIifQ==\n//# sourceURL=webpack-internal:///21\n");
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      isEmo: false,\n      isMore: false,\n      msgCon: '',\n      emojis: [\n      ['😀', '😁', '😂', '🤣', '😃'],\n      ['😄', '😅', '😆', '😉', '😊'],\n      ['😋', '😎', '😍', '😘', '😗'],\n      ['😙', '😚', '😛', '🙂', '🤗'],\n      ['🤔', '😐', '😑', '😶', '🙄'],\n      ['😏', '😣', '😥', '😮', '🤐'],\n      ['😯', '😪', '😫', '😴', '😌']] };\n\n\n  },\n  onLoad: function onLoad() {\n\n  },\n  methods: {\n    subMsg: function subMsg(e) {var _this = this;\n      var pos = this.msgCon.indexOf('\\n');\n      var conRxg = /^\\n+$/g;\n      var flag = conRxg.test(this.msgCon);\n      if (pos !== -1 && !flag && this.msgCon.length > 0) {\n        this.$emit('subMsg', this.msgCon);\n        setTimeout(function () {\n          _this.msgCon = '';\n        }, 0);\n      }\n    },\n    emoApear: function emoApear(e) {\n      __f__(\"log\", e, \" at components/chat/submit.vue:61\");\n      // this.msgCon=\n    },\n    selectEmo: function selectEmo(emo) {\n      __f__(\"log\", emo, \" at components/chat/submit.vue:65\");\n      this.msgCon += emo;\n    },\n    more: function more() {\n      this.isMore = !this.isMore;\n      this.$emit('hightChange', this.isMore);\n    } } };exports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 9)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///25\n");
...
"use strict";
eval("Object.defineProperty(exports, \"__esModule\", { value: true });exports.default = void 0; //\n//\n//\n//\n//\n//\nvar _default =\n{\n  data: function data() {\n    return {\n      emojis: [\n      ['😀', '😁', '😂', '🤣', '😃'],\n      ['😄', '😅', '😆', '😉', '😊'],\n      ['😋', '😎', '😍', '😘', '😗'],\n      ['😙', '😚', '😛', '🙂', '🤗'],\n      ['🤔', '😐', '😑', '😶', '🙄'],\n      ['😏', '😣', '😥', '😮', '🤐'],\n      ['😯', '😪', '😫', '😴', '😌']] };\n\n\n  } };exports.default = _default;//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///30\n");
